...
//         try {
//             const response = await axios.post('/api/properties_list/', formData, {headers: { 'X-CSRFToken': csrftoken }});
...
//                 <form id="basic-details" className="sell-form needs-validation" noValidate>
//                     <div className="row m-0">
//                         <div className={`d-flex form-group-sellpage ${formData.location ? 'filled' : ''} m-2 p-0`}>
//                             <input type="text" className="form-control form-control-sellpage" style={{width:'50%'}} id="location" 
//                             name="location"
...
//                     <div className="row m-0">
//                         <div className={`form-group-sellpage ${formData.address ? 'filled' : ''} m-2 p-0`}>
//                             <input type="text" className="form-control form-control-sellpage" style={{width:'90%'}} id="address"
//                             name="address"
...
//                     <div className="row m-0">
//                         <div className={`form-group-sellpage ${formData.bedrooms ? 'filled' : ''} m-2 p-0`} style={{width:'40%'}} >
//                             <input type="number" className="form-control form-control-sellpage" style={{width:'100%'}} id="bedrooms"
//                             name="bedrooms"
...
//                         <div className={`form-group-sellpage ${formData.bathrooms ? 'filled' : ''} m-2 p-0`} style={{width:'40%'}} >
//                             <input type="number" className="form-control form-control-sellpage" style={{width:'100%'}} id="bathrooms"
//                             name="bathrooms"
...
//                         <div className="input-group m-2 p-0 d-flex align-items-center">
//                             <label className="input-text p-2" style={{color:'#555555'}} htmlFor="images">Upload Images</label>
//                             <input type="file" multiple className="form-control" id="images" 
//                             name="images"
...
//                                 Balcony
//                             </label>
//                             <input className="form-check-input m-2 ms-3 ps-2" type="checkbox" 
//                             name="balcony"
//                             onChange={handleCheckBoxEntry}/>
//                         </div>
...
//                 <form style={{display:'none'}} id="add-details" className="sell-form needs-validation" noValidate>
//                     <div className="row m-0">
//                         <div className={`form-group-sellpage ${formData.description ? 'filled' : ''} m-2 p-0`}>
//                             <textarea type="text" className="form-control-sellpage" style={{width:'60%'}} id="description"
...
//                     <div className="row m-0">
//                         <div className={`input-group form-group-sellpage ${formData.area ? 'filled' : ''} m-2 p-0`} style={{width:'40%', minWidth:'200px'}} >
//                             <input type="number" className="form-control-sellpage" style={{width:'60%', height:'40px'}} id="area"
//                             name="area"
//                             value={formData.area} 
//                             onChange={handleDataEntry}/>
//                             <label htmlFor="area" className="sellpage-label">Area</label>
...
//                         <div className="input-group m-2 p-0" style={{width:'50%', minWidth:'300px'}}>
//                             <label className="input-group-text p-0 d-flex justify-content-center" htmlFor="hometype" style={{width:'40%', minWidth:'100px'}}>Home Type</label>
//                             <select className="form-control-sellpage m-0 py-0" style={{width:'60%', height:'40px'}} id="hometype" name="home_type" 
...
//                         <div className="input-group" style={{width:'50%', height:'40px'}} >
//                             <span className="input-group-text">INR</span>
//                             <input type="number" className="form-control m-0" id="price"
//                             name="price"
