...
const Sell = () => {
    ...
    return (
        <div className="d-flex p-md-5 align-items-center flex-column flex-xl-row" style={{minHeight: '80vh', marginTop: '10vh'}}>
            ...
            <div className="flex-grow-1 d-flex flex-column align-items-end p-5">
                <div className="row mx-0 mt-xl-5 mb-2">
                    <h1 className="pb-3 fs-2 mb-3">Sell your home yourself</h1>
